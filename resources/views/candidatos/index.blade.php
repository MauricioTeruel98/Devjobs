                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="md:flex md:justify-center p-5">
                        <ul class="divide-y divide-gray-500 w-full">
                                ...
                                <li class="p-3 flex items-center">
                                    ...
                                    <div>
                                        <a 
                                            ...
                                            class="inline-flex items-center shadow-sm px-2 py-1 border border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-500"
                                            target="_blank"
                            ...
                            @empty
                                <p class="p-3 text-center text-sm text-gray-500">No hay candidatos aun</p>
                            @endforelse
                        </ul>
                    </div>
                </div>
